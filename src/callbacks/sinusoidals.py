...
from src.constants.mathematics import SINUSOIDALS
...
def format_sinusoidal_title(a, b, c, function_type):
    """
    Generate LaTeX-formatted title following PolynomialCalculator.update_figure_title() patterns.
    """
...
def callback_wrapper(app):
    ...
    def update_graph_from_sliders(coefficients, function_type):
        ...
        x_values = np.linspace(-slider_default["max"], slider_default["max"], 1000)
