...
trace_colours = {
    'default_theme':{index:color_code for index, color_code in enumerate(trace_default_theme_colours)},
    'other_theme': {index:color_code for index, color_code in enumerate(trace_other_theme_colours)}
}
