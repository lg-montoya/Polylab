...
#### Motivation
___
When I began studying polynomials and wanted to 
experiment with them
that process required many manual 
...
6. Changing one of the coefficients in the polynomial, and
repeating steps 1-5 . 

Drawing a quadratic using 7 points would require 42 mathematical operations in my 
head, and I'd spend 
90% of my time on step 2, 5% 
on step 5, but only 3% 
conceptualising the relationship between coefficients and polynomial shapes.
Additionally (and unfortunately), it was not uncommmon for careless mistakes to creep into one of the
42 mathematical operations. The sketch of my graph would then look suspect, and I'd spend time
